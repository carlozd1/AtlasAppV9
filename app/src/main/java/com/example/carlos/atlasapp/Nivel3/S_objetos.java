...
import com.example.carlos.atlasapp.Nivel3.Silabas_objetos.*;
import com.example.carlos.atlasapp.R;
import com.github.clans.fab.FloatingActionButton;
import com.github.clans.fab.FloatingActionMenu;

public class S_objetos extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_silabas_objetos);
    ...
    public void onClick(View v) {
        if(v == bAdelanteObjetos) {
            if(NumeroBoton == 28) {
                Toast aviso = Toast.makeText(this, "Ultima palabra de objetos", Toast.LENGTH_SHORT);
                aviso.show();
                NumeroBoton = 28;
            ...
            if(NumeroBoton == 26){
                Toast aviso = Toast.makeText(this, "Primera palabra de objetos", Toast.LENGTH_SHORT);
                aviso.show();
                NumeroBoton = 26;
                CargarFragment(NumeroBoton);
            } else {
