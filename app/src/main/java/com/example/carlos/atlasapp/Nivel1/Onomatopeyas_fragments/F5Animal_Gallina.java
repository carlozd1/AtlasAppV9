 ...
 * {@link F5Animal_Gallina.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class F5Animal_Gallina extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_f5_animal__gallina, container, false);
    ...
    public void onClick(View v) {
        if (v == oGallina) {
            ...
            //Sonido
            MediaPlayer mp;
            mp = MediaPlayer.create(getActivity(), R.raw.gallina);
            mp.start();
        }
    }
