 ...
 * {@link F8Animal_Gato.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class F8Animal_Gato extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_f8_animal__gato, container, false);
    ...
    public void onClick(View v) {
        if(v == oGato){
            ...
            //Sonido
            MediaPlayer mp;
            mp = MediaPlayer.create(getActivity(), R.raw.gato);
            mp.start();
        }
    }
