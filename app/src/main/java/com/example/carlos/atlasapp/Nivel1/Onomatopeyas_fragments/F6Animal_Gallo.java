 ...
 * {@link F6Animal_Gallo.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class F6Animal_Gallo extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_f6_animal__gallo, container, false);
    ...
    public void onClick(View v) {
        if (v == oGallo) {
            ...
            //Sonido
            MediaPlayer mp;
            mp = MediaPlayer.create(getActivity(), R.raw.gallo);
            mp.start();
        }
    }
