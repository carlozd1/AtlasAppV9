 ...
 * {@link F11Animal_Borrego.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class F11Animal_Borrego extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_f11_animal__borrego, container, false);
    ...
    public void onClick(View v) {
        if(v == oBorrego){
            ...
            //Sonido
            MediaPlayer mp;
            mp = MediaPlayer.create(getActivity(), R.raw.borrego);
            mp.start();
        }
