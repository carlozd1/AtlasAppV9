...
import com.example.carlos.atlasapp.Nivel1.Onomatopeyas_transporte.*;
import com.example.carlos.atlasapp.R;

public class O_transporte extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onomatopeyas_transporte);
    ...
    public void onClick(View v) {
        if (v == bAdelanteTransporte) {
            if (NumeroBoton == 33) {
                Toast aviso = Toast.makeText(this, "Ultima onomatopeya de transporte", Toast.LENGTH_SHORT);
                aviso.show();
                NumeroBoton = 33;
            ...
            if (NumeroBoton == 29) {
                Toast aviso = Toast.makeText(this, "Primera onomatopeya de transporte", Toast.LENGTH_SHORT);
                aviso.show();
                NumeroBoton = 29;
                CargarFragment(NumeroBoton);
            } else {
