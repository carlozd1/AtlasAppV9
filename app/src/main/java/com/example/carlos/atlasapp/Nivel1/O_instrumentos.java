...
import com.example.carlos.atlasapp.Nivel1.Onomatopeyas_instrumentos.*;
import com.example.carlos.atlasapp.R;

public class O_instrumentos extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onomatopeyas_instrumentos);
    ...
    public void onClick(View v) {
        if (v == bAdelanteInstrumento) {
            if (NumeroBoton == 35) {
                Toast aviso = Toast.makeText(this, "Última onomatopeya de instrumentos", Toast.LENGTH_SHORT);
                aviso.show();
                NumeroBoton = 35;
            ...
            if (NumeroBoton == 34) {
                Toast aviso = Toast.makeText(this, "Primera onomatopeya de instrumentos", Toast.LENGTH_SHORT);
                aviso.show();
                NumeroBoton = 34;
                CargarFragment(NumeroBoton);
            } else {
