 ...
 * {@link F15Animal_Rana.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class F15Animal_Rana extends Fragment implements View.OnClickListener{

    private OnFragmentInteractionListener mListener;

    ImageButton oGato, oLobo, oVaca, oBorrego, oElefante, oCaballo, oPato, oRana;

    public F15Animal_Rana() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_f15_animal__rana, container, false);
    ...
    public void onClick(View v) {
        if(v == oRana){
            ...
            //Sonido
            MediaPlayer mp;
            mp = MediaPlayer.create(getActivity(), R.raw.rana);
            mp.start();
        }
    }
