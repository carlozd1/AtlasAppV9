...
import com.example.carlos.atlasapp.Nivel3.Silabas_fragments.*;
...
public class S_animales extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floatingActionButton1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Log.d("boton",n5);
                usarMetodoPalabra(3,NumeroBoton, NumeroPaciente);
    ...
    public void onClick(View v) {
        if(v == bAdelante) {
            if(NumeroBoton == 15) {
                Toast aviso = Toast.makeText(this, "Ultima Silaba", Toast.LENGTH_SHORT);
                aviso.show();
                NumeroBoton = 15;
            ...
            if(NumeroBoton == 0){
                Toast aviso = Toast.makeText(this, "Primera Silaba", Toast.LENGTH_SHORT);
                aviso.show();
                NumeroBoton = 1;
                CargarFragment(NumeroBoton);
            } else {
    ...
    public void CargarFragment(int NumeroBoton){
        ...
        if(fragmentTransaction){
            getSupportFragmentManager().beginTransaction().replace(R.id.content_silabas, fragment).commit();
        }
    }
