 ...
 * {@link F13Animal_Caballo.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class F13Animal_Caballo extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_f13_animal__caballo, container, false);
    ...
    public void onClick(View v) {
        if(v == oCaballo){
            ...
            //Sonido
            MediaPlayer mp;
            mp = MediaPlayer.create(getActivity(), R.raw.caballo);
            mp.start();
        }
